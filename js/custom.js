...
function Marquee0() {
    ...
    for (j = 0; j < colee_left.length; j++) {
        ...
        if (colee_left2[j].offsetWidth - colee_left[j].scrollLeft <= 0) { colee_left[j].scrollLeft -= colee_left1[j].offsetWidth; }
        else {
...
function Marquee1() {
    ...
    for (i = 0; i < colee_right.length; i++) {
        ...
        if (colee_right[i].scrollLeft <= 0) { colee_right[i].scrollLeft += colee_right2[i].offsetWidth; }
        else {
